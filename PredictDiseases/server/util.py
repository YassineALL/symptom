...
df1 = pd.read_csv("PredictDiseases/server/Symptom-severity.csv")
desc = pd.read_excel("PredictDiseases/server/symptom_Description.xlsx")
prec = pd.read_excel("PredictDiseases/server/symptom_precaution.xlsx")
